      ...
      body: Center(
        child: SizedBox(
          ...
          child: ListView.builder(
              ...
              itemCount: asesorController.listapublica.length,
                        ...
                        children: <Widget>[
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    color: Colors.white,
                                    child: Image.network(
                                      asesorController.listapublica[index].foto,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                          ...
                          Positioned(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  "${asesorController.listapublica[index].nombre} ${asesorController.listapublica[index].apellido}",
